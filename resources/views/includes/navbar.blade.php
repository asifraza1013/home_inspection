                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="navbar-users">
                                <ul class="nav nav-sm flex-column">
                                 @can('view-user')
                                    <li class="nav-item">
                                        <a href="{{route('users.index', ['type' =>'admin'])}}" class="nav-link"><span class="sidenav-mini-icon">D </span><span class="sidenav-normal">Admins</span></a>
                                    </li>
                                    @endcan
                                 @can('view-user')
                                    <li class="nav-item">
                                        <a href="{{route('users.index', ['type' =>'clients'])}}" class="nav-link"><span class="sidenav-mini-icon">D </span><span class="sidenav-normal">Clients</span></a>
                                    </li>
                                    @endcan
                                    {{-- @can( 'create-user')
                                    <li class="nav-item">
        ...
        <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ (request()->is('profile.edit*')) ? 'active' : '' }}" href="{{ route('profile.edit', $auth->id) }}">
